...
export const FormSchema = z.object({
  ...
  departament: z.string().nonempty(" o modulo é obrigatorio !"),
  password: z
    .string()
  ...
  massege:z.string().nonempty("É obrigatorio deixar sua mensagem !").min(2, "Deixe pelo menos uma mensagem com 2 caracteres"),
